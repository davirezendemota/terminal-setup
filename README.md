...
- **.cursor/commands** – comando Cursor `/gsync` (commits atômicos, conventional commits, branch protection, push rules)
...
- `.cursor/commands/gsync.md` – comando `/gsync` do Cursor (regras de commit e push)
